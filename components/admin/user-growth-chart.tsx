        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              +{currentMonth?.newUsers || 0} this month
            </p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  >
                    <div className="flex items-end space-x-0.5 h-48">
                      ...
                      <div
                        ...
                        title={`${month.totalUsers} total users`}
                      />
                      {/* New users bar */}
                      <div
                        ...
                        title={`${month.newUsers} new users`}
                      />
                    </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Active users and retention rates</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              {/* Active Users Chart */}
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-green-700">Last 6 months</p>
                </div>
            ...
            <div className="bg-orange-50 p-4 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-orange-700">Month over month</p>
                </div>
