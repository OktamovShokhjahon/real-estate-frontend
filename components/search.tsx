...
export default function SearchPage() {
  ...
  const [idLastFour, setIdLastFour] = useState(
    searchParams.get("idLastFour") || ""
  );
  const [phoneLastFour, setPhoneLastFour] = useState(
    searchParams.get("phoneLastFour") || ""
  );
  ...
  // Set initial values from URL params after component mounts
  useEffect(() => {
    if (typeof window !== "undefined") {
      setCity(searchParams.get("city") || "");
      setStreet(searchParams.get("street") || "");
      setBuilding(searchParams.get("building") || "");
      setIdLastFour(searchParams.get("idLastFour") || "");
      setPhoneLastFour(searchParams.get("phoneLastFour") || "");
    }
  }, [searchParams]);
  ...
  useEffect(() => {
    ...
    // Only search if we have actual values (not just empty strings)
    const hasValidSearchParams = [
      debouncedCity,
      debouncedStreet,
      debouncedBuilding,
        ...
        <CardContent>
          <form onSubmit={handleSearch} className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              {[city, street, building, idLastFour, phoneLastFour].some(
              ...
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  <ul className="text-sm text-muted-foreground mt-2 space-y-1">
                    ...
                    <li>• Проверить последние 4 цифры паспорта</li>
                    <li>• Проверить последние 4 цифры телефона</li>
